...
#define GETTEXT_PACKAGE "libgphoto2_port-0"

/* Define to 1 if you have the <asm/io.h> header file. */
/* #undef HAVE_ASM_IO_H */

/* Define if you have Baudboy serial locking. */
/* #undef HAVE_BAUDBOY */
...
/* Define if we have the resmgr library. */
/* #undef HAVE_RESMGR */

/* Define if you have TIOCM_TRS. */
#define HAVE_RTS_IOCTL 1
...
#define PACKAGE_NAME "libgphoto2 port access library"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libgphoto2 port access library 0.8.0"
